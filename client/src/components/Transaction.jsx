...
export default function Transaction({id, time, name, note, type, amount}) {
  ...
  return (
    <div className='border-solid border-2 border-stone-300 rounded-md my-4'>
      ...
      <div className=" flex justify-between gap-x-6 p-5">
        ...
        <div className="col-1">
        <button onClick={() => deleteTransac(id)} className="rounded-md bg-red-500 px-3 py-1 font-semibold text-white hover:bg-red-400">remove</button>
        </div>
      </div>
    </div>
  )
